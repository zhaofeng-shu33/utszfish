...
$category=array();
$category[]=array("title"=>"生活杂谈","type"=>0,"subtitle"=>"分享你所关心的大事小情","icon"=>"../../images/banner0.jpg");
$category[]=array("title"=>"匿名曝光台","type"=>8,"subtitle"=>"随手拍匿名曝光学城不文明现象","icon"=>"../../images/banner8.jpg");
$category[]=array("title"=>"摄影分享","type"=>1,"subtitle"=>"用镜头探索光影变幻大学家园","icon"=>"../../images/banner1.jpg");
...
$category[]=array("title"=>"运动健康","type"=>5,"subtitle"=>"绕湖慢跑散步遛弯身心健康比什么都重要","icon"=>"../../images/banner5.jpg");
$category[]=array("title"=>"美食烹饪","type"=>6,"subtitle"=>"煎炸炒蒸烘焙分享周边美食","icon"=>"../../images/banner6.jpg");
$category[]=array("title"=>"宿舍租赁","type"=>3,"subtitle"=>"大学城宿舍出租寻租资讯","icon"=>"../../images/banner3.jpg");
